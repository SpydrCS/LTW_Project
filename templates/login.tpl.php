...
<?php function drawLoginSection($error) { ?>
                    ...
                    <div class="login-form-content">
                        <form action="../actions/action_login.php" class="form-search needs-validation" method="post">
                            ...
                            <?php } 
                                ...
                                <span class="error-message">Username doesn't exist!</span>
                            <?php }?>
...
<?php function drawRegisterSection($error) { ?>
        ...
        <div class="rel reg">
            ...
            <div id="signup-container">
                <form action="../actions/action_register.php" class="form-search needs-validation" id="reg-form" autocomplete="off" method="post">
                    ...
                    <?php if ($error == 4) { ?>
                        <span class="error-message">Username already in use! Try a different username</span>
                    <?php } ?>
